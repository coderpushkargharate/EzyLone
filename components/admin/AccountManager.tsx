      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="grid md:grid-cols-[220px_1fr]">
          ...
          <div className="border-b md:border-b-0 md:border-r border-gray-100 bg-gray-50/40 p-3">
            ...
            <a href="https://wa.me/919692429674" target="_blank" rel="noopener noreferrer" className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-white/70">
