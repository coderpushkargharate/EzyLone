  ...
  return (
    <html lang="en-IN" className="scroll-smooth">
      <head>
        ...
        {/* ✅ CRITICAL: Preload the LCP image with correct URL (matches unoptimized Image) */}
        <link
          rel="preload"
          as="image"
        ...
        {/* Preload desktop image (optional but good) */}
        <link
          rel="preload"
          as="image"
      ...
      <body className={`${inter.className} antialiased min-h-screen flex flex-col bg-white text-gray-900`}>
        ...
        {/* Google Ads – afterInteractive to avoid blocking LCP */}
        <Script
          id="google-ads-gtag"
