...
const EMICalculatorPage: React.FC = () => {
  ...
  useEffect(() => {
    const calculateEMI = () => {
      ...
      setTotalAmount(isFinite(emiValue) ? emiValue * time : 0);
      setTotalInterest(isFinite(emiValue) ? emiValue * time - principal : 0);
    };
  ...
  const principalPercentage = totalAmount > 0 ? (loanAmount / totalAmount) * 100 : 0;
  const interestPercentage = totalAmount > 0 ? (totalInterest / totalAmount) * 100 : 0;

  // ✅ FAQ Schema - CORRECT STRUCTURE with "text" field
  const faqSchema = {
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Your EMI is affected by three main factors: the loan amount, interest rate, and loan tenure. A higher loan amount or interest rate increases your EMI, while a longer tenure reduces monthly payments but increases total interest paid. Actual rates vary by lender and applicant profile."
        }
      },
      {
        "@type": "Question",
        "name": "Can I pay more than my EMI amount?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, you can make partial prepayments on most loans. However, some lenders may have prepayment penalties or lock-in periods. Check your specific loan agreement for details. Prepayment policies vary by lender."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "This calculator provides an illustrative estimate based on the inputs you provide. Actual EMI may vary depending on the lender's interest calculation method (reducing balance vs. flat), processing fees, GST, insurance, and other charges. Final terms are determined solely by the disbursing lender."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "A longer tenure reduces your monthly EMI but increases total interest paid over the loan period. A shorter tenure means higher monthly payments but lower total interest. Choose based on your monthly budget and long-term financial goals. Final tenure options subject to lender policy."
        }
      }
    ]
  };
  ...
  const calculatorSchema = {
    ...
    "name": "EMI Calculator - EzyLoan",
    "description": "Free online EMI calculator to estimate monthly loan payments. Calculate EMI for personal loans, car loans, home loans, and business loans with real-time updates.",
    "provider": {
      "@type": "FinancialService",
      "name": "EzyLoan (Dibyansh Associates)",
      "url": "https://ezyloan.co.in"
    },
    "applicationCategory": "LoanCalculator",
    "offers": {
      "@type": "Offer",
      "price": "0",
      "priceCurrency": "INR",
      "description": "Free EMI calculation tool. No registration required."
    },
    "featureList": [
  ...
  const loanComparison = [
    ...
    { type: "Personal Loan", rate: "10.99% - 18.00%", tenure: "Up to 5 years", fee: "Up to 2.5%", prepayment: "Up to 4%" },
    { type: "Property Loan", rate: "8.50% - 12.00%", tenure: "Up to 20 years", fee: "Up to 1%", prepayment: "Nil to 2%" },
    { type: "Commercial Vehicle", rate: "9.50% - 14.00%", tenure: "Up to 7 years", fee: "Up to 2%", prepayment: "Up to 3%" }
  ];
    ...
    <>
      ...
      <div className="pt-32 pb-16 bg-gradient-to-br from-blue-50 via-white to-orange-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {/* Compliance Banner */}
          <div className="mb-6 md:mb-8 p-4 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg" role="note" aria-label="Important calculator disclosures">
            <div className="flex items-start">
              <AlertCircle className="w-5 h-5 text-amber-600 mr-3 mt-0.5 flex-shrink-0" aria-hidden="true" />
              <div className="text-sm text-amber-800">
                <strong>Important:</strong> This EMI calculator provides <strong>illustrative estimates only</strong>. Actual loan terms, interest rates, fees, and EMIs are determined solely by partner lenders based on your credit profile, income, and underwriting policy. <Link href="/loan-disclosure" className="underline hover:text-amber-900">View full disclosures</Link>.
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-8 md:mb-16">
            <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-orange-500 to-amber-500 rounded-xl md:rounded-2xl mb-4 md:mb-6 shadow-2xl transform hover:scale-110 transition-all duration-300">
              <Calculator className="w-8 h-8 md:w-10 md:h-10 text-white" aria-hidden="true" />
            </div>
            <h1 className="text-3xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-6 leading-tight px-4">
              <span className="bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 bg-clip-text text-transparent">EMI Calculator</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 text-xs md:text-sm text-gray-500 px-4" role="list">
              <div className="flex items-center space-x-1 md:space-x-2 bg-white/80 backdrop-blur-sm px-2 md:px-4 py-1 md:py-2 rounded-full shadow-lg" role="listitem">
                <Zap className="w-3 h-3 md:w-4 md:h-4 text-orange-500" aria-hidden="true" />
                <span>Quick Calculation</span>
              </div>
              <div className="flex items-center space-x-1 md:space-x-2 bg-white/80 backdrop-blur-sm px-2 md:px-4 py-1 md:py-2 rounded-full shadow-lg" role="listitem">
                <TrendingUp className="w-3 h-3 md:w-4 md:h-4 text-blue-500" aria-hidden="true" />
                <span>Real-time Updates</span>
              </div>
              <div className="flex items-center space-x-1 md:space-x-2 bg-white/80 backdrop-blur-sm px-2 md:px-4 py-1 md:py-2 rounded-full shadow-lg" role="listitem">
                <PieChart className="w-3 h-3 md:w-4 md:h-4 text-green-500" aria-hidden="true" />
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full text-black pl-10 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300 text-lg font-semibold bg-gray-50/50 hover:bg-white group-hover:border-orange-300"
                ...
                <div className="relative mt-4">
                  <input
                    ...
                    value={loanAmount}
                    onChange={(e) => setLoanAmount(Number(e.target.value))}
                    className="w-full text-black h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full appearance-none cursor-pointer slider hover:from-orange-200 hover:to-amber-200 transition-all duration-300"
                    style={{
              ...
              <div className="group">
                ...
                <div className="relative">
                  <input
                    ...
                    min="5"
                    max="25"
                    className="w-full text-black px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 text-lg font-semibold bg-gray-50/50 hover:bg-white group-hover:border-blue-300"
                ...
                <div className="relative mt-4">
                  <input
                    ...
                    value={interestRate}
                    onChange={(e) => setInterestRate(Number(e.target.value))}
                    className="w-full text-black h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full appearance-none cursor-pointer slider hover:from-blue-200 hover:to-cyan-200 transition-all duration-300"
                    style={{
              ...
              <div className="group">
                ...
                <div className="relative">
                  <input
                    ...
                    min="1"
                    max="360"
                    className="w-full text-black px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-300 text-lg font-semibold bg-gray-50/50 hover:bg-white group-hover:border-green-300"
                ...
                <div className="relative mt-4">
                  <input
                    ...
                    value={loanTenure}
                    onChange={(e) => setLoanTenure(Number(e.target.value))}
                    className="w-full text-black h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full appearance-none cursor-pointer slider hover:from-green-200 hover:to-emerald-200 transition-all duration-300"
                    style={{
          ...
          <div className="mt-20 bg-gradient-to-br from-white via-orange-50/30 to-amber-50/30 rounded-2xl md:rounded-3xl shadow-2xl p-6 md:p-10 border border-white/20 backdrop-blur-sm mb-16">
            <div className="flex items-center justify-center mb-6 md:mb-10">
              ...
              <h2 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-gray-800 via-orange-600 to-amber-600 bg-clip-text text-transparent">Loan Comparison Guide</h2>
            </div>
              ...
              <table className="w-full text-left text-black text-sm md:text-base">
                <thead>
                  <tr className="bg-orange-50">
                    <th className="p-2 md:p-4 rounded-tl-xl" scope="col">Loan Type</th>
                    <th className="p-2 md:p-4" scope="col">Interest Rate Range</th>
                    <th className="p-2 md:p-4" scope="col">Max Tenure</th>
                    <th className="p-2 md:p-4" scope="col">Processing Fee</th>
                    <th className="p-2 md:p-4 rounded-tr-xl" scope="col">Pre-payment Penalty</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100 text-black">
                  {loanComparison.map((loan, index) => (
                    <tr key={index} className="hover:bg-gray-50 text-black">
                      <td className="p-2 md:p-4 font-medium">{loan.type}</td>
                      <td className="p-2 md:p-4">{loan.rate}</td>
                      <td className="p-2 md:p-4">{loan.tenure}</td>
                      <td className="p-2 md:p-4">{loan.fee}</td>
                      <td className="p-2 md:p-4">{loan.prepayment}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <p className="text-xs text-gray-500 mt-4 text-center">
              Rates effective as of {new Date().toLocaleDateString('en-IN')}. Subject to change without notice.
            </p>
          </div>

          {/* FAQ Section - JSON-LD ONLY, NO microdata attributes */}
          <div className="mt-20 bg-gradient-to-br from-white via-purple-50/30 to-pink-50/30 rounded-2xl md:rounded-3xl shadow-2xl p-6 md:p-10 border border-white/20 backdrop-blur-sm">
            <div className="flex items-center justify-center mb-6 md:mb-10">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl md:rounded-2xl flex items-center justify-center mr-3 md:mr-4 shadow-2xl">
                <Info className="w-6 h-6 md:w-8 md:h-8 text-white" aria-hidden="true" />
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-8 max-w-6xl mx-auto">
              {[
                { q: "What factors affect my EMI?", a: "Your EMI is affected by three main factors: the loan amount, interest rate, and loan tenure. A higher loan amount or interest rate increases your EMI, while a longer tenure reduces monthly payments but increases total interest paid. Actual rates vary by lender and applicant profile." },
                { q: "Can I pay more than my EMI amount?", a: "Yes, you can make partial prepayments on most loans. However, some lenders may have prepayment penalties or lock-in periods. Check your specific loan agreement for details. Prepayment policies vary by lender." },
                { q: "How accurate is this EMI calculator?", a: "This calculator provides an illustrative estimate based on the inputs you provide. Actual EMI may vary depending on the lender's interest calculation method (reducing balance vs. flat), processing fees, GST, insurance, and other charges. Final terms are determined solely by the disbursing lender." },
                { q: "Should I choose a longer or shorter loan tenure?", a: "A longer tenure reduces your monthly EMI but increases total interest paid over the loan period. A shorter tenure means higher monthly payments but lower total interest. Choose based on your monthly budget and long-term financial goals. Final tenure options subject to lender policy." }
              ].map((faq, index) => (
                <div key={index} className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-4 md:p-8 shadow-xl border border-white/30 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 group">
                  <div className="flex items-center mb-3 md:mb-4">
                    ...
                    <h3 className="text-base md:text-xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">{faq.q}</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-lg">{faq.a}</p>
                </div>
              ))}
            </div>
